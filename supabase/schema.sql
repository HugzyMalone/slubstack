...
-- Generic live-match finaliser (8-arg superset; see migration 20260531000200_ranked_bot_rating).
-- p_allow_bot_rating defaults false so solo-vs-bot matches never write ratings unless opted in.
...
-- F2 Daily Challenge: per-day results + denormalised streaks (additive; see migration 20260531000100).
...
-- Async ghost duels (F4). Mirrors migration 20260531020000_ghost_runs.sql.
