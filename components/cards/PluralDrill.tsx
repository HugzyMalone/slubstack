...
export function PluralDrill({ card, onResult, onFeedback, strictTypos = true }: Props) {
  ...
  const accepted = [normalise(plural)].filter(Boolean);
            ...
            isCorrect ? (
              isNearMissOnFirstTry ? (
                <span className="font-bold text-success">
                  Almost — correct spelling: {plural}
                </span>
              ) : (
                <span className="font-bold text-success">
                  Correct — {plural}
